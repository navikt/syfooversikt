...
- This application contains a list of persons that have a sick leave, with different tasks ("hendelse" or "oppgave")
  administrated by a "veileder".
...
- Domain names in the app:
  ...
  - "kartleggingssporsmal" (questions asked to the sick person to evaluate their situation and needs early in the sick
    leave process)
